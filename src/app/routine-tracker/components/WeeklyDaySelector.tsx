                ...
                <div className="flex-1 flex items-center gap-4 min-w-0">
                  ...
                  {isEditMode && onDeleteItem && (
                    <button
                      ...
                      className="flex-shrink-0 p-1.5 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded transition-colors duration-200 opacity-0 group-hover:opacity-100"
